		...
		const char *buf, size_t len)
{
    ...
    if (sscanf(buf, "%d %d %d %d %d %d %d %d %d %d %d %d %d %d %d",
        ...
        aw210xx_single_led_br_set(aw210xx, 8, frame_brightness[0] * aw210xx->setting_br / 4095);
        aw210xx_single_led_br_set(aw210xx, 15, frame_brightness[1] * aw210xx->setting_br / 4095);
        aw210xx_single_led_br_set(aw210xx, 14, frame_brightness[2] * aw210xx->setting_br / 4095);
        aw210xx_single_led_br_set(aw210xx, 10, frame_brightness[3] * aw210xx->setting_br / 4095);
        aw210xx_single_led_br_set(aw210xx, 12, frame_brightness[4] * aw210xx->setting_br / 4095);
        aw210xx_single_led_br_set(aw210xx, 9, frame_brightness[5] * aw210xx->setting_br / 4095);
        aw210xx_single_led_br_set(aw210xx, 11, frame_brightness[6] * aw210xx->setting_br / 4095);
        aw210xx_single_led_br_set(aw210xx, 13, frame_brightness[7] * aw210xx->setting_br / 4095);
        aw210xx_update(aw210xx);
